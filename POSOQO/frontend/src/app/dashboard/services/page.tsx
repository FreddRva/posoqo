...
export default function ServicesPage() {
  ...
  const handleSaveService = async (updatedService: Service) => {
    try {
      ...
      alert('Error al guardar el servicio: ' + (error as Error).message);
    }
  };
  ...
  const handleDelete = async (serviceId: string) => {
    ...
    try {
      ...
      alert(`Eliminando servicio con ID: ${serviceId}`);
                        ...
                        <div className="flex-shrink-0 w-12 h-12">
                          {service.image_url ? (
                            <img
                              ...
                              src={service.image_url.startsWith('http') ? service.image_url : `http://localhost:4000${service.image_url}`}
                              alt={service.name}
                              onError={(e) => {
