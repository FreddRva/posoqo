...
export default function HomePage() {
  ...
  return (
    <div className={`min-h-screen premium-gradient text-white ${montserrat.className} pt-4 lg:pt-8 relative overflow-hidden`}>
      ...
      {/* Servicios - Mismo diseño que cervezas y gastronomía */}
      <section id="servicios" className="py-20 relative overflow-hidden bg-gradient-to-br from-slate-900 via-gray-800 to-slate-900">
