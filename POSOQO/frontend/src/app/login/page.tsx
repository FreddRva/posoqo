  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0a0714] via-[#18151f] to-[#0f0f0f] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Card del formulario */}
        <div className="bg-[#18151f]/90 backdrop-blur-xl border border-[#D4AF37]/30 rounded-3xl p-8 shadow-2xl shadow-[#D4AF37]/10">
          
          {/* Header con logo */}
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-gradient-to-r from-[#D4AF37] to-[#FFD700] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
              <span className="text-2xl font-bold text-black">P</span>
            </div>
            <h1 className="text-3xl font-bold text-white mb-2">Bienvenido a POSOQO</h1>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border transition-all duration-300 ${
                    errors.email 
                      ...
                      : "border-[#D4AF37]/40 bg-gray-800/50 focus:border-[#D4AF37] focus:bg-gray-800 focus:ring-[#D4AF37]/20"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-[#D4AF37] transition-colors p-1"
                  disabled={loading}
                >
                  {showPassword ? (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#D4AF37] to-[#FFD700] text-black font-bold py-4 px-6 rounded-xl hover:from-[#FFD700] hover:to-[#D4AF37] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl hover:shadow-[#D4AF37]/30 transform hover:scale-[1.02]"
            >
              {loading ? (
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#18151f] text-[#D4AF37] font-medium">o continúa con</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white text-gray-800 font-semibold py-4 px-6 rounded-xl hover:bg-gray-50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl transform hover:scale-[1.02] border border-gray-200"
          >
          ...
          <div className="mt-8 text-center space-y-3">
            <p className="text-gray-400 text-sm">
              ...
              <Link 
                href="/register" 
                className="text-[#D4AF37] hover:text-[#FFD700] transition-colors font-semibold hover:underline"
              >
                Regístrate aquí
              </Link>
            </p>
            <div className="text-center">
              <Link 
                href="/" 
                className="text-gray-500 hover:text-gray-300 transition-colors text-sm flex items-center justify-center"
              >
