        ...
        <div className="bg-[#18151f]/80 backdrop-blur-xl border border-[#FFD700]/20 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#18151f] text-gray-400">o continúa con</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white text-gray-800 font-semibold py-3 px-4 rounded-lg hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
          >
