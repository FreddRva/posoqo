  ...
  return (
    <footer className="w-full bg-gray-100 text-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex justify-center">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gray-200 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-300 transition-colors"
          >
            Más información
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 border-t border-gray-300">
        <div className="flex flex-wrap justify-center items-center space-x-6 text-xs text-gray-500 mb-4">
          <a href="/terminos" className="hover:text-gray-700 transition-colors">Términos y condiciones</a>
          <a href="/privacidad" className="hover:text-gray-700 transition-colors">Política de privacidad</a>
          <a href="/accesibilidad" className="hover:text-gray-700 transition-colors">Accesibilidad</a>
          <a href="/ayuda" className="hover:text-gray-700 transition-colors">Ayuda</a>
        </div>
      </div>
