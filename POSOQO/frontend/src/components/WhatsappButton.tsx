...
export default function WhatsappButton() {
  return (
    <a
      ...
      className="fixed z-[9999] bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl hover:shadow-green-500/30 flex items-center justify-center w-16 h-16 transition-all duration-300 group hover:scale-110 animate-pulse"
      style={{
        position: 'fixed',
        zIndex: 9999,
        bottom: '24px',
