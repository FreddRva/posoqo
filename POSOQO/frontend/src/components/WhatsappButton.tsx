...
export default function WhatsappButton() {
  return (
    <a
      href="https://wa.me/51999999999" // Reemplaza por tu número real
      target="_blank"
      rel="noopener noreferrer"
      className="fixed z-50 bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg flex items-center justify-center w-16 h-16 transition-all group"
    ...
    >
      ...
      <span className="absolute opacity-0 group-hover:opacity-100 bg-black text-white text-xs rounded px-2 py-1 left-0 -translate-x-full ml-2 transition-all pointer-events-none">WhatsApp</span>
    </a>
  );
} 