...
export default function WhatsappButton() {
  return (
    <a
      ...
      className="fixed z-[9999] bottom-5 right-5 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center w-14 h-14 transition-all duration-200 group hover:scale-105"
      style={{
        position: 'fixed',
        zIndex: 9999,
        bottom: '20px',
      ...
      aria-label="Contactar por WhatsApp - 966 123 456"
    >
      <svg
      ...
      <span className="absolute opacity-0 group-hover:opacity-100 bg-gray-900 text-white text-xs font-medium rounded-lg px-3 py-1.5 right-full mr-3 transition-all duration-200 pointer-events-none whitespace-nowrap shadow-lg">
        ¡Escríbenos! 966 123 456
      </span>
    </a>
  );
} 