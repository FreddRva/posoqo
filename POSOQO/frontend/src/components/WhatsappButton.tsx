...
export default function WhatsappButton() {
  return (
    <a
      ...
      className="fixed z-50 bottom-6 right-6 bg-gradient-to-r from-[#D4AF37] to-[#FFD700] hover:from-[#FFD700] hover:to-[#D4AF37] text-black rounded-full shadow-2xl hover:shadow-[#D4AF37]/30 flex items-center justify-center w-16 h-16 transition-all duration-300 group hover:scale-110"
    ...
    >
      ...
      <span className="absolute opacity-0 group-hover:opacity-100 bg-black text-[#D4AF37] text-xs font-bold rounded px-3 py-2 left-0 -translate-x-full ml-2 transition-all pointer-events-none whitespace-nowrap shadow-lg">
        ¡Escríbenos!
      </span>
    </a>
  );
